<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Head.aspx.cs" Inherits="DSBBS.Admin.Head" %>
      ...
      <ul id="login">
          <li><%if (Session["AdminName"] == null)
                ...
                <li><%if (Session["AdminName"] == null)
                      ...
                      {
                          Context.Response.Write("<a href='AuserMess.aspx'><i id='i3'></i>用户管理</a>");
                      }%></li>
               <%if (Session["AdminName"] != null)
                 ...
                 <%if (Session["AdminName"]!=null&&Session["AdminName"].ToString() == "sysadmin")
                      {
                          Context.Response.Write(" <li><a href='EditAdmin.aspx'><i id='i4'></i>权限管理</a></li>");
                      }%>
                <li><%if (Session["AdminName"] == null)
                      {
                          Context.Response.Write("<a href='/Admin/SysAdmin.aspx'><i id='i4'></i>系统登录</a>");
                      }
                      else
                      {
                          Context.Response.Write("<a href='AdminLogin.aspx?exitUser=1'><i id='i4'></i>退出登录</a>");
                      }%></li>
      </ul>
   </div>
