<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="TestForNet.WEB.PersionalInformation" %>
...
<html lang="en" class="demo-loading no-js">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/WEB/CSS/Index/normalize.css" />
		<link rel="stylesheet" type="text/css" href="/WEB/CSS/Index/demo.css" />
		<link rel="stylesheet" type="text/css" href="/WEB/CSS/Index/component.css" />
		<!--[if IE]>
	...
	<body>
		<div class="container">
			<header class="codrops-header">
				...
				<div data-svg="logo" class="codrops-logo hide"></div>
			</header>
			<div class="main">
				<div class="headline">
				...
				<section>
                	<figure>
						...
						<a href="/Index.aspx?newTime=1"><img data-svg="thumb5" class="hide" src="/WEB/Images/Index/img/thumb5.png" alt="img05" /></a>
						<figcaption>
					...
					<figure>
						...
						<img data-svg="thumb1" class="hide" src="/WEB/Images/Index/img/thumb1.png" alt="img01" onclick="ingTip()"  />
						<figcaption>
							<svg id="figheadline1" class="line-drawing" width="200" height="320" viewBox="0 0 200 320" xmlns="http://www.w3.org/2000/svg">
								<path class="darker" d="m2.5,177.750244c0,-1.086761 0.913242,-2 2,-2l122.218567,0c1.086761,0 2,0.913239 2,2l0,15.091995c0,1.086761 -0.913239,2 -2,2l-122.218567,0c-1.086758,0 -2,-0.913239 -2,-2l0,-15.091995z" />
							</svg>
							<h2 data-svg="figheadline1" class="hide">考察</h2>
							...
							<p data-svg="figparagraph1" class="hide">学习进度考察，个人检测</p>
						</figcaption>
					</figure>
					<figure>
						...
						<img data-svg="thumb2" class="hide" src="/WEB/Images/Index/img/thumb2.png" alt="img02" onclick="ingTip()" />
						<figcaption>
							<svg id="figheadline2" class="line-drawing" width="200" height="320" viewBox="0 0 200 320" xmlns="http://www.w3.org/2000/svg">
								<path class="darker" d="m2.5,177.750244c0,-1.086761 0.913242,-2 2,-2l122.218567,0c1.086761,0 2,0.913239 2,2l0,15.091995c0,1.086761 -0.913239,2 -2,2l-122.218567,0c-1.086758,0 -2,-0.913239 -2,-2l0,-15.091995z" />
							</svg>
							<h2 data-svg="figheadline2" class="hide">讨论区</h2>
							...
							<p data-svg="figparagraph2" class="hide">讨论疑难，资源分享</p>
						</figcaption>
					</figure>
					
			</section>
		</div><!-- /container -->
		<script src="/WEB/JS/Index/classie.js"></script>
		<script src="/WEB/JS/Index/svganimations2.js"></script>
	</body>
</html>
