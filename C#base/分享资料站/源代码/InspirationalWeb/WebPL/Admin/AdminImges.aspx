<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminImges.aspx.cs" Inherits="InspirationalWeb.WebPL.Admin.AdminImges" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function doDel(id) {
            if (confirm("您确定要删除吗？")) {
                window.location = "/WebPL/Admin/AdminImges.aspx?del=1&id=" + id;
            }
            return false;
        }
...
<body>
    ...
    <div id="Main">
        ...
        <form method="post" action="AdminImges.aspx">
<table class="tbList">
        <tr id="tbth">
    ...
    <tr id="tbPage">
           ...
           <td style="width:160px"> <a  href="AdminImges.aspx?pageNumber=<%=pageNumber-1 %>">上一页</a>            </td>
          
          <td style="width:80px"> 第<%=pageNumber %>页         </td>
          
           <td style="width:160px"> <a  href="AdminImges.aspx?pageNumber=<%=pageNumber+1 %>">下一页</a>            </td>
