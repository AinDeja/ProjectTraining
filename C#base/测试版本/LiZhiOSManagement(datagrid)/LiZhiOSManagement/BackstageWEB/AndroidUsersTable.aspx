<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AndroidUsersTable.aspx.cs" Inherits="LiZhiOSManagement.WEB.AndroidUsersTable" %>
...
<link href="JQueryEasyUI/themes/default/easyui.css" rel="stylesheet" />
    ...
    <script>
        ...
        function InitList() {
            $("#tt").datagrid({
                url: 'Ajax/TableByUsersDatagrid.ashx?belongkind=Android&bysel=ID&byserch=*',
                title: '数据列表',
                //width: 1190,
                //height: 460,
                fitColumns: true,
                ...
                , '-', {
                    ...
                    handler: function () {
                        ...
                        if ($('#searchin').val().length > 0) {
                            alert($('#searchsel').val());
                            alert($('#searchin').val());
                            $("#tt").datagrid({ url: "Ajax/TableByUsersDatagrid.ashx?belongkind=Android&bysel=" + $('#searchsel').val() + "&byserch=" + $('#searchin').val() });
                            $("#tt").datagrid('reload');
                        }
                        else {
                            alert("搜索框不能为空");
...
<body class="easyui-layout">
    ...
    <table style="margin-left:auto;margin-right:auto;vertical-align:middle;margin-top:20px;">
        ...
        <tr><td>组别</td><td>
            ...
            <%--<select class="group" style="width:143px;"><option>.Net</option><option>Front-end</option><option selected="selected">Android</option></select>--%>
            ...
            <%
                ...
                {
                    %>
            <select class="group" style="width:143px;"><option>.Net</option><option>Front-end</option><option selected="selected">Android</option></select></td><td><span style="color:red;">&nbsp;&nbsp;*</span>
            <%
                }
                else
                {
