...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //    $('.colorBlue').bind("click", function () {
        //        $('.theHead').css('background-color', '#E9F1FF');
        //        $('.theTail').css('background-color', '#E9F1FF');
        //    });
        //    $('.changeColor .colorYellow').bind("click", function () {
        //        $('.theHead').css('background-color', '#ffff66');
        //        $('.theTail').css('background-color', '#ffff66');
        //    });
        //    $('.changeColor .colorRed').bind('click', function () {
        //        $('.theHead').css('background-color', '#ff6666');
        //        $('.theTail').css('background-color', '#ff6666');
        //    });
        //})
    ...
    <style type="text/css">
        * {
        ...
        .logo>h1{position:absolute;left: 100px}
         .changeColor{float: right;}
...
<body class="easyui-layout">                  
    ...
    <div class="theHead" style="min-height: 80px; background-color: #E9F1FF; text-align: left; line-height:80px; width: 100%">
        <div class="logo" id="menu">
        <img src="LZLOGO.png" width="80px" />
        <h1>LiZhiOS</h1>
        </div>
        <div class="changeColor" style="height:20px;margin-top:50px;" >
        <!-- <p width="20px">更改主题：</p> -->
            <div class="color colorBlue" style="float:left;width:20px;height: 20px;background: #E9F1FF;border: 2px solid #ccc ;border-radius:5px;margin-left:5px;" onclick="blue()"></div>
            <div class="color colorYellow" style="float:left;width:20px;height: 20px;background:#ffff66;border: 2px solid #ccc;border-radius:5px;margin-left:5px;" onclick="yellow()"></div>
            <div class="color colorRed" style="float:left;width:20px;height: 20px;background: #ff6666; border: 2px solid #ccc;border-radius:5px;margin-left:5px;" onclick="red()"></div>
        </div>
    </div>
            ...
            <div id="aa" class="easyui-accordion" data-options="fit:true" style="width:100%;">
                <div title="签到信息管理" data-options="selected:true">
                    <ul class="am">
                        ...
                        <li class="li2"><a href="OutSignOfExcle.aspx" target="mainFrame"><div title=".Net" data-options="" style="background-color:#C3E6C8;overflow: auto;height:30px;line-modal-contentheight:30px;font-size:14px;border:1px solid #A9FACD;">签到信息导出</div></a></li>
    ...
    <!-- 底部，版权信息-->
     <div class="theTail" data-options="region:'south',border:false" style="height: 50px; background-color: #A9FACD;text-align: center;line-height:50px;">
