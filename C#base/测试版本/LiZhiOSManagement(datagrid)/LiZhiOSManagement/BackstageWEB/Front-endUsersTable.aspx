<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Front-endUsersTable.aspx.cs" Inherits="LiZhiOSManagement.WEB.Front_endUsersTable" %>
...
<link href="JQueryEasyUI/themes/default/easyui.css" rel="stylesheet" />
    ...
    <script>
        ...
        function InitList() {
            $("#tt").datagrid({
                url: 'Ajax/TableByUsersDatagrid.ashx?belongkind=Front-end&bysel=ID&byserch=*',
                title: '数据列表',
                //width: 1190,
                //height: 460,
                fitColumns: true,
                ...
                , '-', {
                    ...
                    handler: function () {
                        ...
                        if ($('#searchin').val().length > 0) {
                            alert($('#searchsel').val());
                            alert($('#searchin').val());
                            $("#tt").datagrid({ url: "Ajax/TableByUsersDatagrid.ashx?belongkind=Front-end&bysel=" + $('#searchsel').val() + "&byserch=" + $('#searchin').val() });
                            $("#tt").datagrid('reload');
                        }
                        else {
                            alert("搜索框不能为空");
...
<body class="easyui-layout">
    ...
    <table style="margin-left:auto;margin-right:auto;vertical-align:middle;margin-top:20px;">
        ...
        <tr><td>组别</td><td>
            ...
            <%--<select class="group" style="width:143px;"><option>.Net</option><option selected="selected">Front-end</option><option>Android</option></select></td><td><span style="color:red;">&nbsp;&nbsp;*</span>--%>
            <%
