<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllManagersTable.aspx.cs" Inherits="LiZhiOSManagement.WEB.AllManagersTable" %>
...
<link href="JQueryEasyUI/themes/default/easyui.css" rel="stylesheet" />
    ...
    <script>
        ...
        function InitList() {
            $("#tt").datagrid({
                url: 'Ajax/TableByManagersDatagrid.ashx?belongkind=All&bysel=ID&byserch=*',
                title: '数据列表',
                //width: 1190,
                //height: 460,
                fitColumns: true,
                    ...
                    if ($('#tt').datagrid('getChecked').length <= 0) {
                        ...
                        $('#dabtnadd').bind('click', function () {
                            if ($('#tt').datagrid('getChecked').length > 0) {
                                ...
                                $.get('DeleteManager.ashx', { shuzu: sz }, function (data) {
