<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminSignView.aspx.cs" Inherits="LiZhiOSManagement.Management.adminSignView" %>
...
<head>
    ...
    <title>签到信息</title>
    <link rel="stylesheet" type="text/css" href="/WEB/CSS/SignTable.css">
    <link rel="stylesheet" type="text/css" href="/WEB/CSS/SignStyle.css" />
...
<body>
    ...
    <div class="zzsc-container">
        <div id="page">
            <span><h1 align="center">励志工作室<a href="adminSign.aspx"> <img width="100px"></a> <%=selectToDayTime %>日签到时间表</h1></span>
            <table id="table">
                <thead>
                    <tr>
                        <th>姓名</th>
