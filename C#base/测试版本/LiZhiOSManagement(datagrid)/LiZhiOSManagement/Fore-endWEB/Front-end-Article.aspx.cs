...
{
    public partial class Front_end_Article : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (((s != null) && (!s.Equals("")) || ((Request.Params["makeComment"] != null) && (!makeComment.Equals("")))) && (Session["ID"] != null))
                {
                    ...
                    {
                        i = ambll.addMessage(false, DateTime.Now, "Android", Convert.ToInt32(Session["articleID"]), makeComment, cid, Session["txtUser"].ToString());
                        if (i == 1)
                        {
                            Response.Redirect("Front-end-Article.aspx?ID=" + Convert.ToInt32(Session["articleID"]));
                        }
                ...
                if (Request.Params["deletecommentid"] != null && (!Request.Params["deletecommentid"].Equals("")))
                {
                    ...
                    if (j == 1)
                    {
                        ...
                        deleteids = "Front-end-Article.aspx?ID=" + deletecommentids;
                        //string ajaxdelete = "OK";
                        //Response.Redirect("Android-Article.aspx?ID=" + Convert.ToInt32(Session["articleID"]));
                    }
