<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Front-end-Article.aspx.cs" Inherits="LiZhiOSManagement.Fore_endWEB.Front_end_Article" ValidateRequest="false" %>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav pull-left">
        ...
        <li><a href="Front-end-Article.aspx">发表文章</a></li>
      <li>
...
<div id="comments" class="comment-list clearfix">
          ...
          <span class="order">（
            <a data-order="asc" class="active" href="Front-end-Article.aspx?times=shun">按时间正序</a>·
            <a data-order="desc" href="Front-end-Article.aspx?times=ni">按时间倒序</a>·
            <a data-order="likes_count" href="Front-end-Article.aspx?times=fav">按喜欢排序</a>
              ）
          </span>
    ...
    喜欢(<span class="favorite"><%=sf.SelectFavoriteMessagesCount(listChildrenMessages[i].ID,Convert.ToInt32(Session["articleBysearchID"])) %></span>)</a>
                            ...
                            <div class="comment-text">
                                <form action="Front-end-Article.aspx?commentId=<%=Convert.ToInt32(listChildrenMessages[i].ID) %>" method="post">
