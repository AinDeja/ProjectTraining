...
{
    public partial class Android_Search : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string s = null;
            string kindtype = "Android";
            ...
            if (pageCount >= 1)
            {
                s = s + "<nav style=" + "\"" + "margin:0 auto;width:100%;" + "\"" + "><ul class=" + "\"" + "pagination pagination-lg" + "\"" + "><li><a href=" + "Android-Search.aspx?count=" + "1" + "&searchMsg=" + selectMsg + " aria-label=" + "\"" + "Previous" + "\"" + "><span aria-hidden=" + "\"" + "true" + "\"" + ">&laquo;</span></a></li>";
                string splus = null;
                if (pageCount <= 9)
                {
                    ...
                    {
                        splus += "<li><a href=" + "\"" + "Android-Search.aspx?count=" + i + "&searchMsg=" + selectMsg + "\"" + ">" + i + "</a></li>";
                    }
                    s = s + splus;
                }
                else
                {
                    ...
                    s = s + splus + "<li><a href=" + "\"" + "Android-Search.aspx?count=" + pageCount + "&searchMsg=" + selectMsg + "\"" + " aria-label=" + "\"" + "Next" + "\"" + "><span aria-hidden=" + "\"" + "true" + "\"" + ">&raquo;" + "</span></a></li></ul></nav>";
                }
