<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Android-Article.aspx.cs" Inherits="LiZhiOSManagement.Fore_endWEB.Android_Article" ValidateRequest="false"%>
...
<body>
    <a href="#" id="back-to-top"><i class="fa fa-angle-up"><span class="glyphicon glyphicon-chevron-up"></span>
    ...
    <div class="container">
        <div class="row">
          ...
          喜欢(<span class="favorite" id="a"><%=sf.SelectFavoriteArticleCount(Convert.ToInt32(Session["articleID"]),Convert.ToString(Session["kind_type"])) %></span>)</a>
          ...
          <span class="order">（
            <a data-order="asc" class="active" href="Android-Article.aspx?times=shun">按时间正序</a>·
            <a data-order="desc" href="Android-Article.aspx?times=ni">按时间倒序</a>·
            <a data-order="likes_count" href="Android-Article.aspx?times=fav">按喜欢排序</a>
              ）
          </span>
                    ...
                    <div id="comment-list">
                        ...
                        <div class="note-comment clearfix" id="comment-1" style="overflow:auto;">
                            ...
                            <div class="comment-toolbar clearfix">
                                ...
                                <a href="javascript:void(0)" class="like pull-left" commentid="<%=listChildrenMessages[i].ID %>" userid="<%=Convert.ToInt32(Session["ID"]) %>" articleid="<%=Convert.ToInt32(Session["articleBysearchID"])%>">
                                    <% 
    ...
    喜欢(<span class="favorite"><%=sf.SelectFavoriteMessagesCount(listChildrenMessages[i].ID,Convert.ToInt32(Session["articleBysearchID"])) %></span>)</a>
                            ...
                            <div class="comment-text">
                                <form action="Android-Article.aspx?commentId=<%=Convert.ToInt32(listChildrenMessages[i].ID) %>" method="post">
