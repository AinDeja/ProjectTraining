<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Android-Search.aspx.cs" Inherits="LiZhiOSManagement.Fore_endWEB.Android_Search" ValidateRequest="false" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <title>Android讨论区</title>
    <link href="CSS/bootstrap.min.css" rel="stylesheet" />
    <link href="CSS/luntan.css" rel="stylesheet" />
</head>
<body>
    <a href="javascript:void(0)" id="back-to-top"><i class="fa fa-angle-up"> <span class="glyphicon glyphicon-chevron-up" ></span></i></a>
    <nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <!-- Brand and toggle get grouped for better mobile display -->
    <div class="navbar-header">
      <a class="navbar-brand" href="Android.aspx">Android</a>
    </div>
      ...
      <ul class="nav navbar-nav pull-left">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="Front-end/Front-end.aspx">Front-end讨论区</a></li>
          </ul>
  		</li>
        <li><a href="Android-Write-Article.aspx">发表文章</a></li>
      <li>
     <form class="navbar-form " role="search" method="get" action="Android-Search.aspx">
            ...
            <div class="panel-group table-responsive" role="tablist">
                <div class="panel panel-primary leftMenu">
                    ...
                    <div id="collapseListGroup1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading1">
                        <ul class="list-group">
                            <li class="list-group-item" pb="bynew" count="1" kind_type="Android" onclick="leftnav(this)">
                                <a href="javascript:void(0)">最新发布</a>
                            </li>
                            <li class="list-group-item" pb="bycomment" count="1" kind_type="Android" onclick="leftnav(this)">
                               <a href="javascript:void(0)">最多回复</a>
                            </li>
                            <li class="list-group-item" pb="byfavorite" count="1" kind_type="Android" onclick="leftnav(this)">
                               <a href="javascript:void(0)">最多喜欢</a>
                            </li>
                            <li class="list-group-item" pb="bywatch" count="1" kind_type="Android" onclick="leftnav(this)">
                ...
                <div class="panel panel-primary leftMenu">
                    ...
                    <div id="collapseListGroup2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading2">
                        <ul class="list-group">
                           <li class="list-group-item leftnavajax" pb="hour" count="1" kind_type="Android" onclick="leftnav(this)">
                               <a href="javascript:void(0)">24小时内</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="week" count="1" kind_type="Android" onclick="leftnav(this)">
                              <a href="javascript:void(0)">近一周</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="month" count="1" kind_type="Android" onclick="leftnav(this)">
                               <a href="javascript:void(0)">近一月</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="year" count="1" kind_type="Android" onclick="leftnav(this)">
