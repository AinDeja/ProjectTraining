    ...
    public partial class Android : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string s = null;
                ...
                if (dcount != null)
                {
                    list = sabll.ShowFy(Convert.ToInt32(dcount),"Android");
                }
                else
                {
                    list = sabll.ShowFy(Convert.ToInt32(1),"Android");
                }
                ...
                //总页数
                int pageCount = Convert.ToInt32(Math.Ceiling((double)selectArticleCount.SelectArticleCount("Android") / 5));
                ...
                if (pageCount >= 1)
                {
                    ...
                    if (pageCount <= 9)
                    {
                        ...
                        {
                            splus += "<li><a href=" + "\"" + "Android.aspx?count=" + i + "\"" + ">" + i + "</a></li>";
                        }
                        s = s + splus;
                    }
                    else
                    {
                        ...
                        s = s + splus + "<li><a href=" + "\"" + "Android.aspx?count=" + pageCount + "\"" + " aria-label=" + "\"" + "Next" + "\"" + "><span aria-hidden=" + "\"" + "true" + "\"" + ">&raquo;" + "</span></a></li></ul></nav>";
                    }
