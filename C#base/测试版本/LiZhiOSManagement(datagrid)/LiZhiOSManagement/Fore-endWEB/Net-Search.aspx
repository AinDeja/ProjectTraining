<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Net-Search.aspx.cs" Inherits="LiZhiOSManagement.Fore_endWEB.Net_Search" %>
...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="Android.aspx">.Net</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav pull-left">
        ...
        <li><a href="Net-Write-Article.aspx">发表文章</a></li>
      <li>
            ...
            <div class="panel-group table-responsive" role="tablist">
                <div class="panel panel-primary leftMenu">
                    ...
                    <div id="collapseListGroup1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading1">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" pb="bycomment" count="1" kind_type=".NET" onclick="leftnav(this)">
                               <a href="javascript:void(0)">最多回复</a>
                            </li>
                            <li class="list-group-item" pb="byfavorite" count="1" kind_type=".NET" onclick="leftnav(this)">
                               <a href="javascript:void(0)">最多喜欢</a>
                            </li>
                            <li class="list-group-item" pb="bywatch" count="1" kind_type=".NET" onclick="leftnav(this)">
                ...
                <div class="panel panel-primary leftMenu">
                    ...
                    <div id="collapseListGroup2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading2">
                        <ul class="list-group">
                           <li class="list-group-item leftnavajax" pb="hour" count="1" kind_type=".NET" onclick="leftnav(this)">
                               <a href="javascript:void(0)">24小时内</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="week" count="1" kind_type=".NET" onclick="leftnav(this)">
                              <a href="javascript:void(0)">近一周</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="month" count="1" kind_type=".NET" onclick="leftnav(this)">
                               <a href="javascript:void(0)">近一月</a>
                            </li>
                            <li class="list-group-item leftnavajax" pb="year" count="1" kind_type=".NET" onclick="leftnav(this)">
