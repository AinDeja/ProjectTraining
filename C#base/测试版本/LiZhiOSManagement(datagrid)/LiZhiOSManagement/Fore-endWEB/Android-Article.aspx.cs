...
{
    public partial class Android_Article : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.Params["deletecommentid"] != null && (!Request.Params["deletecommentid"].Equals("")))
                {
                    ...
                    if (j == 1)
                    {
                        ...
                        deleteids = "Android-Article.aspx?ID=" + deletecommentids;
