    ...
    public class T_SignIN
    {
       /* public DataTable searchByName(string name)
        ...
        public string setNewSignIN(string userName,string time)
        {
            ...
            if ( serachEnd== null)//【新增当天】全部人员签到概况
            {
            ...
            SqlParameter[] pms = new SqlParameter[] { 
                new SqlParameter("@name", System.Data.SqlDbType.NVarChar) { Value = Stu["UserFname"] } ,//不以UFNAME标识
           ...
           int newTime=Sql.ExecuteNonQuery(sql, System.Data.CommandType.Text, pms);
                tip = "签到成功！";
            }
            else//【更新】签到信息
            {
