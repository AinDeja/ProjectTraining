...
{
    public class AddUsersByManagerDAL
    {
        ...
        {
            string sql = "insert into T_User(IsDelete,CreateTime,UserName,UserPassWord,UserSex,UserStuID,UserIP,Belong,UserQQ,UserPhone,UserFname) values(@isdelete,@createtime,@username,@userpassword,@usersex,@userstuid,@userip,@belong,@userqq,@userphone,@userfname); ";
        ...
        {
            string sql = "update T_User set IsDelete=@isdelete,CreateTime=@createtime,UserName=@username,UserPassWord=@pwd,UserSex=@usersex,UserStuID=@userstuid,UserIP=@userip,Belong=@belong,UserQQ=@userqq,UserPhone=@userphone,UserFname=@userfname where ID=@id";
            SqlParameter[] sp = new SqlParameter[]{
