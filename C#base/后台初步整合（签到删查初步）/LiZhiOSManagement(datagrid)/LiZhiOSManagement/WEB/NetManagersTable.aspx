<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetManagersTable.aspx.cs" Inherits="LiZhiOSManagement.WEB.NetManagersTable" %>
...
<link href="JQueryEasyUI/themes/default/easyui.css" rel="stylesheet" />
    ...
    <script>
        ...
        function InitList() {
            $("#tt").datagrid({
                url: 'Ajax/TableByManagersDatagrid.ashx?belongkind=.Net&bysel=ID&byserch=*',
                title: '数据列表',
                //width: 1190,
                //height: 460,
                fitColumns: true,
