<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AndroidManagersTable.aspx.cs" Inherits="LiZhiOSManagement.WEB.AndroidManagersTable" %>
...
<link href="JQueryEasyUI/themes/default/easyui.css" rel="stylesheet" />
    ...
    <script>
        ...
        function InitList() {
            $("#tt").datagrid({
                url: 'Ajax/TableByManagersDatagrid.ashx?belongkind=Android&bysel=ID&byserch=*',
                title: '数据列表',
                //width: 1190,
                //height: 460,
                fitColumns: true,
