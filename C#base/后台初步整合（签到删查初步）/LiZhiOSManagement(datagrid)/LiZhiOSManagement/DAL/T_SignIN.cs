...
namespace LiZhiOSManagement.DAL
{
    public class T_SignIN
    {
       /* public DataTable searchByName(string name)
        ...
        /// <returns></returns>
          public string DeleteID(string sumID)
          {
              string sql = "update  T_SignIN SET IsDelete=1 WHERE ID IN  (" + sumID + ")";
          ...
          /// <param name="sumID"></param>
          /// <returns></returns>
          public string DeleteDay(string sumDay)
          {
              string sql = "update T_SignIN SET IsDelete=1 WHERE toDay IN (" + sumDay + ")";
              Sql.ExecuteDataTable(sql, System.Data.CommandType.Text);
              return "OKfromDAL";
          }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
          public DataTable showForDeleteFalse()
          {
              string sql = "select*from T_SignIN  where IsDelete is null or IsDelete=0";
              DataTable view = Sql.ExecuteDataTable(sql, System.Data.CommandType.Text);
              return view;
          }
          /// <summary>
          ...
          /// </summary>
          /// <returns></returns>
          public DataTable showForDeleteTrue()
          {
              string sql = "select*from T_SignIN  where IsDelete=1";
              DataTable view = Sql.ExecuteDataTable(sql, System.Data.CommandType.Text);
              return view;
          }
